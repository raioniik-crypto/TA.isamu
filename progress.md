...
| 日付 | 内容 | コミット |
|------|------|---------|
| 2026-04-09 | 相棒感: 成長パラメータ連動の反応バリエーション | `b7613b8` |
| 2026-04-09 | セキュリティ: IPv4-mapped IPv6 hex-hextet バイパス修正 | `decde82` |
| 2026-04-09 | セキュリティ: IPv6 ドメイン名 false positive 修正 | `f4a1038` |
| 2026-04-09 | 相棒感: ページ閲覧開始時のリアルタイムコメント | `d291e17` |
...
- [ ] 会話記憶の永続化と参照
- [x] ページ閲覧開始時のリアルタイムコメント (30s cooldown + URL dedup + 800ms delay)
- [x] 成長パラメータ連動の反応バリエーション (reaction-messages.ts, trait bonus pool)
- [ ] 成長システムの可視化改善
- [ ] モバイル体験の最適化
